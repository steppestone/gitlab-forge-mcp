...
// Structurally identical to GitLabCommitDiff; kept as a distinct exported name
...
export interface GitLabAccessToken {
  ...
  /** Present only on project/group access tokens. */
  accessLevel?: number;
  /** The raw token string — returned ONLY in the create response. */
  token?: string;
}
